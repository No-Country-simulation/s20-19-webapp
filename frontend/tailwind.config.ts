...
const config: Config = {
  darkMode: 'class', // Esto permite cambiar al modo oscuro con la clase "dark"
  content: [
    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          ...
          orange50: 'hsl(var(--orange-50))',
          orange400: 'hsl(var(--orange-400))',
          gray100: 'hsl(var(--gray-100))',
          gray300: 'hsl(var(--gray-300))',
          gray400: 'hsl(var(--gray-400))',
