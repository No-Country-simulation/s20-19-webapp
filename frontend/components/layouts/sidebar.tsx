      ...
      <div className="space-y-4">
        <div className="flex flex-col space-y-[24px]">
          ...
          <div className="mt-4">
            {/* Categorías */}
            <button 
              className="w-full flex items-center justify-between px-4 py-2 text-white hover:bg-green-900 rounded-lg transition-all duration-300"
            ...
            {openCategories && (
              <div className="pl-6 mt-2 space-y-2 text-gray-200 text-sm">
                <button className="w-full text-left hover:text-gray-800 text-gray-900">Todas</button>
              </div>
            )}
            ...
            {openPrice && (
              <div className="pl-6 mt-2 space-y-2 text-gray-200 text-sm">
                <button className="w-full text-left hover:text-gray-800 text-gray-900">Todos</button>
              </div>
            )}
            ...
            {openLocation && (
              <div className="pl-6 mt-2 space-y-2 text-gray-200 text-sm">
                <button className="w-full text-left hover:text-gray-800 text-gray-900 flex gap-1">
                  <Image src="/icons/ubication.svg" alt="Descuento" width={15} height={15} />
                  Ubicación
                </button>
              </div>
            )}
